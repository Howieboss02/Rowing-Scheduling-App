...
public class EmailStrategyTest {
  ...
  public Event event = new Event(1L, "Training 1", new ArrayList<>(), new TimeSlot(1, Day.MONDAY, new Node(12 * 60 , 14 * 60)), Certificate.B1, EventType.TRAINING, true, "M", "Bob's camp");
