...
public class PlatformStrategyTest {
    ...
    public void testPlatformAccepted() {
        ...
        assertEquals("Bob, you have been accepted to Training 1 "
                + "- TRAINING from 12:00 until 14:30 in week 1, on MONDAY.\n", message);
    }
    ...
    public void testPlatformRejected() {
        ...
        assertEquals(1, user.getNotifications().size());
        assertEquals("Bob, you have been rejected from Training 1 "
                + "- TRAINING from 12:00 until 14:30 in week 1, on MONDAY.\n", message);
    }
}