...
public class PlatformStrategyTest {
  ...
  public Event event = new Event(1L, "Training 1", new ArrayList<>(),new TimeSlot(1, Day.MONDAY, new Node(12*60, 14 * 60 + 30)), Certificate.B1, EventType.TRAINING, true, "M",  "Bob's camp");
  ...
  public void testPlatformAccepted(){
    ...
    assertEquals("Bob, you have been accepted to Training 1 - TRAINING from 12:00 until 14:30 in week 1, on MONDAY.\n", message);
  }
  @Test
  public void testPlatformRejected(){
    ...
    assertEquals(1, user.getNotifications().size());
    assertEquals("Bob, you have been rejected from Training 1 - TRAINING from 12:00 until 14:30 in week 1, on MONDAY.\n", message);
  }
}