...
public class UserControllerTest {
    ...
    public void testRemoveTimeSlot() {
        final TimeSlot removedTime = new TimeSlot(1, Day.FRIDAY, Pair.of(11, 13));
        final TimeSlot correctTime = new TimeSlot(1, Day.FRIDAY, Pair.of(11, 12));

        User u = getUser("A", Certificate.B1);

        sut.registerNewUser(u);
        sut.addRecurringTimeSlot(1L, Day.FRIDAY, Pair.of(10, 12));
